...
ansible -i ./ansible-inventory.yaml -m shell -a "curl -sfL https://get.k3s.io | K3S_URL=$K3S_URL K3S_TOKEN=$K3S_TOKEN INSTALL_K3S_CHANNEL=stable sh -s -" g_workers --forks 1 -vv

deactivate


echo -e "\nWorker node upgrade done\n\n"
kubectl version
echo
kubectl get nodes
echo -e "\n"
