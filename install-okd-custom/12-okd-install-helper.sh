...
echo >./cluster_config.env

echo "KUBECONFIG=$(pwd)/auth/kubeconfig"    >> ./cluster_config.env   
echo "PATH=$(pwd)/../bin:${PATH}"           >> ./cluster_config.env
echo ". $(pwd)/../bin/kubectl_completion"   >> ./cluster_config.env
echo ". $(pwd)/../bin/oc_completion"        >> ./cluster_config.env
echo ". $(pwd)/../bin/osi_completion"       >> ./cluster_config.env
echo "oc get nodes"                         >> ./cluster_config.env
